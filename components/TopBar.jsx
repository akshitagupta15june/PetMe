            ...
            <nav className="">
                <div className="hidden w-full lg:block z-0" id="navbar">
                    <ul
                        ...
                        <li><a href="/blog"
                               className="p-3 text-custom-heading font-bold hover:underline underline-offset-4 turn-red-hover navbar-item">Blogs</a>
                        </li>
                        <li>
                            <a href="/donate"
                               className="p-3 text-custom-heading font-bold hover:underline underline-offset-4 turn-red-hover navbar-item">
                        ...
                        <li>
                            <a id="theme-toggle">
                                <img src="/assets/sun.svg" width="50px" id="switch"/>
                            </a>
                        </li>
                    </ul>
                </div>
